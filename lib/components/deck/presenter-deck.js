...
var PresenterDeck = function PresenterDeck(props) {
  ...
  return _react.default.createElement(PresenterDeckContainer, null, _react.default.createElement(NotesColumn, null, _react.default.createElement(_layout.FlexBox, {
    ...
    paddingTop: 10,
    paddingX: 15
  }, _react.default.createElement(_logo.default, null), _react.default.createElement(_layout.FlexBox, {
    width: 0.75,
    ...
    padding: "0px",
    margin: "0px 0px 10px"
  }, "AAAAAA Open a second browser tab at ", window.location.host, " to use as the audience deck", !!castButton && ' or use Chrome’s display cast to present on a secondary display', "."), castButton)), _react.default.createElement(_layout.Box, {
    paddingRight: 15
